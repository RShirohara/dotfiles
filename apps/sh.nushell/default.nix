{ ... }: {
  ...
  programs.nushell.extraConfig = ''
    ...
    def --env ghq-cd []: nothing -> nothing {
  ...
  programs.nushell.settings = {
    ...
    history.max_size = 100000000;
    ls.use_ls_colors = true;
    render_right_prompt_on_last_line = true;
    rm.always_trash = true;
    shell_integration.osc133 = true;
    shell_integration.osc2 = false;
    shell_integration.osc633 = true;
    shell_integration.osc7 = true;
    shell_integration.osc8 = true;
